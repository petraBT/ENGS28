...
| ch-ble.ptx | Day17 | **Day 17 done** — book passed after her comment rounds, deck passed 2026-09-11 ("Okay, deck is finished"), in-class prose refined from the passed deck; history in `plans/week9-handover.md` sessions 1–4 |
| ch-power.ptx | Day17x | **Day 17x done** — chapter passed 2026-09-12, deck passed 2026-09-13 ("Amazing. Done.") after three comment batches; her pet-once ruling (KEY_UPDATE after KEY_START) applied in book and deck — she still owed the same two lines to the Canvas watchdog.c; history in `plans/week9-handover.md` sessions 4–5 |
| — (no chapter) | Day18, Day19 | **Day 18 is a pure work day** (her ruling 2026-09-13: no deck, no slides). **Day 19 done** — demos and wrap-up, deck only (`assets/decks/day19.json`, 18 slides, all glue, 7 instructor-only incl. the modernized choosing-a-microcontroller block), passed 2026-09-14 ("Done!") after four comment rounds; `plans/day19.md`, `reviews/day19-gate3.md`. **This closed the course: every day is delivered and passed** |
