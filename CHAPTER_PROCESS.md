...
| ch-servos.ptx | Day15, Day15x | **Week 8 session 1 done (2026-09-02): ground truth, week map, Day 15 and 15x plans through Gate 1 (list applied, `reviews/week8-gate1.md`); nine questions with Petra (`plans/week8-ground-truth.md` §9). No prose yet — the placeholder chapter is condemned in §7. Next: `plans/day15-prompt.md`, the Day 15 book |
