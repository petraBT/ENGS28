...
| ch-accelerometers.ptx | Day13, Day13x, Day14 | chapter file still rough (Day 13 moved here from ch-i2c, Petra's call) — **Week 7 planned through Gate 1, list applied** (2026-08-26): `plans/week7-ground-truth.md`, `plans/week7.md`, three day plans, `reviews/week7-gate1.md`, build prompts `plans/day13-prompt.md`/`day13x-prompt.md`/`day14-prompt.md`; questions to Petra in ground truth §9; next is session 2 (build Day 13) — see `plans/week7-handover.md` |
