...
PreTeXt source for the ENGS 28 textbook (Thayer School of Engineering, Dartmouth).

**→ [AUTHORING.md](AUTHORING.md) is the one to read**: editing, building, git,
and deploying, in one place.

Also: [CHAPTER_PROCESS.md](CHAPTER_PROCESS.md) for how to write a chapter,
[CLAUDE.md](CLAUDE.md) for conventions and gotchas, and
[scripts/README-editing.md](scripts/README-editing.md) for the click-to-source
editing tools.

The rest of this file is the generic advice that came with `pretext new book`.
